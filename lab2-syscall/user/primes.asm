...
int main(int argc,char* argv[]){
  ...
  1a:	406080e7          	jalr	1030(ra) # 41c <pipe>
  ...
  26:	3e2080e7          	jalr	994(ra) # 404 <fork>
  2a:	892a                	mv	s2,a0
  2c:	02054f63          	bltz	a0,6a <main+0x6a>
		fprintf(2,"fork error\n");
		exit(1);
	}
	else if(pid == 0){
  30:	10051663          	bnez	a0,13c <main+0x13c>
		close(pl[1]);
  34:	fbc42503          	lw	a0,-68(s0)
  38:	00000097          	auipc	ra,0x0
  3c:	3fc080e7          	jalr	1020(ra) # 434 <close>
		int prime = 0,n,pr[2];
  40:	84ca                	mv	s1,s2
		int first = 1;
  42:	4985                	li	s3,1
  ...
  48:	914a8a93          	addi	s5,s5,-1772 # 958 <malloc+0x106>
		while(read(pl[0],&n,1) != 0){
  4c:	a0b1                	j	98 <main+0x98>
		fprintf(2,"pipe error\n");
  4e:	00001597          	auipc	a1,0x1
  52:	8ea58593          	addi	a1,a1,-1814 # 938 <malloc+0xe6>
  56:	4509                	li	a0,2
  58:	00000097          	auipc	ra,0x0
  5c:	70e080e7          	jalr	1806(ra) # 766 <fprintf>
		exit(1);
  60:	4505                	li	a0,1
  62:	00000097          	auipc	ra,0x0
  66:	3aa080e7          	jalr	938(ra) # 40c <exit>
		fprintf(2,"fork error\n");
  6a:	00001597          	auipc	a1,0x1
  6e:	8de58593          	addi	a1,a1,-1826 # 948 <malloc+0xf6>
  72:	4509                	li	a0,2
  74:	00000097          	auipc	ra,0x0
  78:	6f2080e7          	jalr	1778(ra) # 766 <fprintf>
		exit(1);
  7c:	4505                	li	a0,1
  7e:	00000097          	auipc	ra,0x0
  82:	38e080e7          	jalr	910(ra) # 40c <exit>
				prime = n;
  86:	fac42483          	lw	s1,-84(s0)
				printf("prime %d\n",prime);
  8a:	85a6                	mv	a1,s1
  8c:	8556                	mv	a0,s5
  8e:	00000097          	auipc	ra,0x0
  92:	706080e7          	jalr	1798(ra) # 794 <printf>
					close(pr[1]);
				}
				else
					close(pr[0]);
  ...
  96:	ec99                	bnez	s1,b4 <main+0xb4>
		while(read(pl[0],&n,1) != 0){
  98:	4605                	li	a2,1
  9a:	fac40593          	addi	a1,s0,-84
  9e:	fb842503          	lw	a0,-72(s0)
  a2:	00000097          	auipc	ra,0x0
  a6:	382080e7          	jalr	898(ra) # 424 <read>
  aa:	c13d                	beqz	a0,110 <main+0x110>
			if(prime == 0){
  ac:	dce9                	beqz	s1,86 <main+0x86>
			else if(first){
  ae:	02099263          	bnez	s3,d2 <main+0xd2>
int main(int argc,char* argv[]){
  b2:	89ca                	mv	s3,s2
			if(prime != 0 && n % prime != 0){
  b4:	fac42783          	lw	a5,-84(s0)
  b8:	0297e7bb          	remw	a5,a5,s1
  bc:	dff1                	beqz	a5,98 <main+0x98>
				write(pr[1],&n,1);
  be:	4605                	li	a2,1
  c0:	fac40593          	addi	a1,s0,-84
  c4:	fb442503          	lw	a0,-76(s0)
  c8:	00000097          	auipc	ra,0x0
  cc:	364080e7          	jalr	868(ra) # 42c <write>
  d0:	b7e1                	j	98 <main+0x98>
				pipe(pr);
  d2:	fb040513          	addi	a0,s0,-80
  d6:	00000097          	auipc	ra,0x0
  da:	346080e7          	jalr	838(ra) # 41c <pipe>
				if(fork() == 0){
  de:	00000097          	auipc	ra,0x0
  e2:	326080e7          	jalr	806(ra) # 404 <fork>
  e6:	8a2a                	mv	s4,a0
  e8:	ed09                	bnez	a0,102 <main+0x102>
					pl[0] = pr[0];
  ea:	fb042783          	lw	a5,-80(s0)
  ee:	faf42c23          	sw	a5,-72(s0)
					close(pr[1]);
  f2:	fb442503          	lw	a0,-76(s0)
  f6:	00000097          	auipc	ra,0x0
  fa:	33e080e7          	jalr	830(ra) # 434 <close>
					prime = 0;
  fe:	84d2                	mv	s1,s4
 100:	bf61                	j	98 <main+0x98>
					close(pr[0]);
 102:	fb042503          	lw	a0,-80(s0)
 106:	00000097          	auipc	ra,0x0
 10a:	32e080e7          	jalr	814(ra) # 434 <close>
 10e:	b755                	j	b2 <main+0xb2>
			}
		}
		close(pr[1]);
 110:	fb442503          	lw	a0,-76(s0)
 114:	00000097          	auipc	ra,0x0
 118:	320080e7          	jalr	800(ra) # 434 <close>
		close(pl[0]);
 11c:	fb842503          	lw	a0,-72(s0)
 120:	00000097          	auipc	ra,0x0
 124:	314080e7          	jalr	788(ra) # 434 <close>
		wait(0);
 128:	4501                	li	a0,0
 12a:	00000097          	auipc	ra,0x0
 12e:	2ea080e7          	jalr	746(ra) # 414 <wait>
		exit(0);
 132:	4501                	li	a0,0
 134:	00000097          	auipc	ra,0x0
 138:	2d8080e7          	jalr	728(ra) # 40c <exit>
	}
	close(pl[0]);
 13c:	fb842503          	lw	a0,-72(s0)
 140:	00000097          	auipc	ra,0x0
 144:	2f4080e7          	jalr	756(ra) # 434 <close>
	for(int i = 2 ;i <= 35 ;i++){
 148:	4789                	li	a5,2
 14a:	faf42823          	sw	a5,-80(s0)
 14e:	02300493          	li	s1,35
		write(pl[1],&i,1);
 152:	4605                	li	a2,1
 154:	fb040593          	addi	a1,s0,-80
 158:	fbc42503          	lw	a0,-68(s0)
 15c:	00000097          	auipc	ra,0x0
 160:	2d0080e7          	jalr	720(ra) # 42c <write>
	for(int i = 2 ;i <= 35 ;i++){
 164:	fb042783          	lw	a5,-80(s0)
 168:	2785                	addiw	a5,a5,1
 16a:	0007871b          	sext.w	a4,a5
 16e:	faf42823          	sw	a5,-80(s0)
 172:	fee4d0e3          	bge	s1,a4,152 <main+0x152>
	}
	close(pl[1]);
 176:	fbc42503          	lw	a0,-68(s0)
 17a:	00000097          	auipc	ra,0x0
 17e:	2ba080e7          	jalr	698(ra) # 434 <close>
	wait(0);
 182:	4501                	li	a0,0
 184:	00000097          	auipc	ra,0x0
 188:	290080e7          	jalr	656(ra) # 414 <wait>
	exit(0);
 18c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 504:	47050513          	addi	a0,a0,1136 # 970 <digits>
 508:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5d0:	3a4b8b93          	addi	s7,s7,932 # 970 <digits>
 ...
 710:	25c90913          	addi	s2,s2,604 # 968 <malloc+0x116>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7d8:	1b47b783          	ld	a5,436(a5) # 988 <freep>
...
malloc(uint nbytes)
{
 ...
 87a:	11253503          	ld	a0,274(a0) # 988 <freep>
 ...
 8a2:	0ea90913          	addi	s2,s2,234 # 988 <freep>
  if(p == (char*)-1)
 8a6:	5afd                	li	s5,-1
 8a8:	a88d                	j	91a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 8aa:	00000797          	auipc	a5,0x0
 8ae:	0e678793          	addi	a5,a5,230 # 990 <base>
 8b2:	00000717          	auipc	a4,0x0
 8b6:	0cf73b23          	sd	a5,214(a4) # 988 <freep>
 8ba:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8dc:	0aa73823          	sd	a0,176(a4) # 988 <freep>
      return (void*)(p + 1);
